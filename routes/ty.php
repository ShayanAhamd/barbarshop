...
Route::get('/customerDetail/{client_id}/{customer_id}',[HomeController::class,'customerDetail'])->name('customerDetail');
...
Route::get('/customersajax',[HomeController::class,'customersajax'])->name('ajax.customers');

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6" onclick="addtocard({{$product->id}})" style="cursor: pointer;">
                ...
                <div class="content-right">
                    ...
                    <div class="content-right-center">
                        ...
                        @endphp
                            ...
                            @php
                             ...
                             @endphp
                        <div class="order-item" id="orderItem_{{$id}}">

                          <div class="order-item-detail">
                            <p id="pname">{{ Str::limit($details['name'], 8) }}
                            <br>
                          ...
                          <div class="order-item-edit">
                            <span>
                              ...
                              <button
                                ...
                                @endif
                              >
                                <img src="../../assets/icons/order-1.svg" alt="tag">
                              </button>
                            ...
                            <span>
                                ...
                                <button type="button" class="btn-styleless" onclick="deletecartitem({{$id}})">
                                  <svg
                                  width="20"
                                  height="23"
                                  viewBox="0 0 20 23"
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="box-body box-body-inner">
                                  ...
                                  <button type="button" class="btn-styleless" data-bs-dismiss="modal" onclick="discount({{$details['price']}},{{$id}},'{{$discount->name}}',{{$discount->id}},{{$discount->percentage}} )">
                      ...
                      $totaldiscount = 0; 
                      @endphp
                      @foreach(session('cart') as $key => $disc)
                      @php
                      $totaldiscount += intval($disc['discount_value']);
                      @endphp 
                      @endforeach
                      @endif
                    ...
                    <div class="content-right-footer">
                            ...
                            <table class="right-table-text">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ count((array) session('cart')) }}</td>
                                    </tr>
                                    <tr>
                                        <td scope="row">Total Discount</td>
                                        @if(session('cart'))
                                        <td class="totalDiscount">${{ number_format($totaldiscount,2)}}</td>
                                        @else
                                        <td>$0.00</td>
                                        @endif
                                    </tr>
                            ...
                            <table class="right-table-text">
                                <tbody>
                                    ...
                                    <tr>
                                        <td scope="row">Due</td>
                                        @if(session('cart'))
                                        <td class="duePrice">${{ number_format($total, 2)}}</td>
                                        @else
                                        <td>$0.00</td>
                                        @endif
                                    </tr>
                        ...
                        <div class="content-right-footer-btn">
                            <a  style="text-decoration: none"  href="{{route('destory.all.cart.items')}}">
                            ...
                            @if(session('cart'))
                            <button type="button" id="orderN" class="footer-btn" style="background: var(--orang-2)"
                             onclick="order( {{$subtotal}} )">
                                <span> 
                            ...
                            @else
                            <button type="button" class="footer-btn" style="background: var(--orang-2)">
                               <span> 
                                   <svg width="18" height="19" viewBox="0 0 18 19" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
                                       <path
                           ...
                           @endif
                            @if(session('cart'))
                            <button class="footer-btn" style="background: var(--green)" data-bs-toggle="modal"
              ...
              <div class="pay-modal-content">
                          ...
                          <div class="row mt-4">
                              <div class="col-md-8 offset-md-2">
                                  <div
                                      ...
                                      <button type="buttonn"
                                          class="btn-orang px-5 py-2 rounded">Cash</button>
                                      <button type="buttonn"
                                          class="btn-orang px-5 py-2 rounded">Card</button>
                                      <button type="buttonn"
                                          class="btn-orang px-5 py-2 rounded">Online</button>
                                  </div>
                              </div>
                          </div>
                          <div class="row mt-2">
                  ...
                  <div class="modal-footer footerbg justify-content-center">
                      <button class="footer-btn px-3" style="background: var(--red)">
                        <img src="../../assets/icons/trash-18x19.svg" alt="">
                        Cancel
                      </button>
                      <button class="footer-btn px-3" style="background: var(--green)">
                        <img src="../../assets/icons/tick.svg" alt="mark">
                        Check out
                      </button>
                  </div>
              </div>
  ...
  $.ajax({
            ...
            data: {
              ...
              success: function (response) {
                ...
                $("#orderN").attr("onclick","order('"+data.grand_total+"')");
              
                // var clickfun = $("#orderN").attr("onClick");
                // var funname = clickfun.substring(0,clickfun.indexOf("("));       
                // $("#orderN").attr("onclick",funname+"('somethingDiff1')");
              }
        });
   ...
   $.ajaxSetup({ 
    ...
    $.ajax({
              ...
              success: function (response) {
                ...
                $('.duePrice').html('$'+data.due_Price_after_discount);
                $('.totalDiscount').html('$'+data.totalDiscount);
                $('#exampleModal_'+prod_id).modal('toggle');
                $('#popupBtn'+prod_id).attr("data-bs-target",""); 
                $('#popupBtn'+prod_id).attr("data-bs-toggle","");  
...
$.ajaxSetup({ 
    ...
    $.ajax({
              ...
              success: function (response) {
                ...
                $('#noteModal_'+prod_id).modal('toggle');
                $('#popupBtnNote'+prod_id).attr("data-bs-target",""); 
                $('#popupBtnNote'+prod_id).attr("data-bs-toggle","");  

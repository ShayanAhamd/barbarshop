                    ...
                    <div class="content-right-footer">
                        ...
                        <div class="content-right-footer-btn">
                            <a  style="text-decoration: none"  href="{{route('destory.all.cart.items')}}">
                              ...
                              @if(session('cart'))
                            <button type="button" id="orderN" class="footer-btn" style="background: var(--orang-2)" onclick=" order({{$subtotal}})">
                                <span>
              ...
              <div class="pay-modal-content">
                          ...
                          <div class="row mt-4">
                              <div class="col-md-8 offset-md-2">
                                  <div
                                      ...
                                      <button type="buttonn"
                                          class="btn-orang2 px-5 py-2 rounded">Cash</button>
                                      <button type="buttonn"
                                  ...
                                  <div class="d-flex align-content-center justify-content-between">
                                      <div class="col-7">
                                          <textarea name="Comments" id=""
                                              class="w-100 text-area"></textarea>
                                      </div>
                  ...
                  <div class="modal-footer footerbg justify-content-center">
                      <button class="footer-btn px-3" style="background: var(--red)">
                        <img src="../../assets/icons/trash-18x19.svg" alt="trash">
                        Cancel
                      </button>

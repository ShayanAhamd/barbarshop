          ...
          <div class="middle py-5">
            ...
            <div class="select-user-name w-75">
              ...
              <div  class="select-user-col">
                <p  data-name="{{ $client->business_name }}" class="col-head">{{$client->business_name}}</p>
              </div>
              @endforeach
            </div>
          </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          ...
          <div class="modal-content">
              ...
              <div class="box-body">
                ...
                <input type="text" maxlength="1" id="codeBox1" name="pass1" class="modal-input" onkeyup="onKeyUpEvent(1, event)" onfocus="onFocusEvent(1)" style="font-size:2em">
                <input type="text" maxlength="1" id="codeBox2" name="pass2" class="modal-input" onkeyup="onKeyUpEvent(2, event)"  onfocus="onFocusEvent(2)" style="font-size:2em">
                <input type="text" maxlength="1" id="codeBox3" name="pass3" class="modal-input" onkeyup="onKeyUpEvent(3, event)"  onfocus="onFocusEvent(3)" style="font-size:2em">
                <input type="text" maxlength="1" id="codeBox4" name="pass4" class="modal-input" onkeyup="onKeyUpEvent(4, event)"  onfocus="onFocusEvent(4)" style="font-size:2em">
              </div>
